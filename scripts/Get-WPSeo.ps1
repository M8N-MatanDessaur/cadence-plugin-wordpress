<#
.SYNOPSIS
    The SEO fields (Yoast and Rank Math) of an item, and what is rendered in the head.
.EXAMPLE
    ./scripts/Get-WPSeo.ps1 -Type pages -Id 28
#>
[CmdletBinding()]
param(
    [string]$Type = 'pages',
...
Get-Api "/api/plugins/wordpress/seo/$(Esc $Type)/$Id" | ConvertTo-Json -Depth 8
