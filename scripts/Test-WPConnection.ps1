<#
.SYNOPSIS
    Checks the login: who the application password signs in as, with which roles.
.EXAMPLE
    ./scripts/Test-WPConnection.ps1
#>
[CmdletBinding()]
param(
    [string]$Site = ''
...
Get-Api '/api/plugins/wordpress/test' | ConvertTo-Json -Depth 4
