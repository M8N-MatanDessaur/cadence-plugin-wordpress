...
.EXAMPLE
    ./scripts/New-WPTerm.ps1 -Taxonomy categories -Name Recipes
#>
[CmdletBinding()]
param(
...
Fail-IfWpError (Post-Api "/api/plugins/wordpress/terms/$(Esc $Taxonomy)" $payload) | Select-Object -Property id, name, slug | ConvertTo-Json
