<#
.SYNOPSIS
    Where a media file is used: as a featured image, or mentioned in content.
.EXAMPLE
    ./scripts/Get-WPMediaUsage.ps1 -Id 22060
#>
[CmdletBinding()]
param(
...
Get-Api "/api/plugins/wordpress/media/$Id/usage" | ConvertTo-Json -Depth 5
