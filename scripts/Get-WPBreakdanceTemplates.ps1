<#
.SYNOPSIS
    Breakdance templates, headers, footers, popups and blocks.
.EXAMPLE
    ./scripts/Get-WPBreakdanceTemplates.ps1
#>
[CmdletBinding()]
param(
    [string]$Site = ''
...
Get-Api '/api/plugins/wordpress/breakdance/templates' | ConvertTo-Json -Depth 5
