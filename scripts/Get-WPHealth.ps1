<#
.SYNOPSIS
    The site at a glance: post types with counts, drafts, pending, scheduled, comments waiting, media, plugins seen, recent items, issues, bridge.
.EXAMPLE
    ./scripts/Get-WPHealth.ps1
#>
[CmdletBinding()]
param(
    [string]$Site = ''
...
Get-Api '/api/plugins/wordpress/health' | ConvertTo-Json -Depth 8
