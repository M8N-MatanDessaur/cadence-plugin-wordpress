<#
.SYNOPSIS
    One item in full: content, excerpt, featured image, terms, author, SEO fields, page-builder summary, snapshots.
.EXAMPLE
    ./scripts/Get-WPItem.ps1 -Type pages -Id 28
#>
[CmdletBinding()]
param(
    [string]$Type = 'pages',
...
Get-Api "/api/plugins/wordpress/item?type=$(Esc $Type)&id=$Id" | ConvertTo-Json -Depth 20
