<#
.SYNOPSIS
    Every post type and taxonomy with counts and rest base, plus the plugins detected from REST namespaces. Read this before touching a custom type.
.EXAMPLE
    ./scripts/Get-WPDiscover.ps1
#>
[CmdletBinding()]
param(
    [string]$Site = ''
...
Get-Api '/api/plugins/wordpress/discover' | ConvertTo-Json -Depth 6
