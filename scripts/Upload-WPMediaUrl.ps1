<#
.SYNOPSIS
    Downloads a file from a URL and uploads it to the library.
.EXAMPLE
    ./scripts/Upload-WPMediaUrl.ps1 -Url https://example.com/a.jpg -AltText "..."
#>
[CmdletBinding()]
param(
...
$r = Fail-IfWpError (Post-Api '/api/plugins/wordpress/media/upload-url' $payload)
[pscustomobject]@{ ok = [bool]$r.id; id = $r.id; url = $r.source_url } | ConvertTo-Json
